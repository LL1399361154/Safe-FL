...
class PaillierPublicKey(object):
    ...
    def raw_encrypt(self, plaintext, obfuscator):
    ...
    def encrypt(self, value, obfuscator, precision=None):
        ...
        return self.encrypt_encoded(encoding, obfuscator)

    def encrypt_encoded(self, encoding, obfuscator):
        ...
        ciphertext = self.raw_encrypt(encoding.encoding, obfuscator)

        encrypted_number=EncryptedNumber(self, ciphertext, encoding.exponent, True)    
...
class EncryptedNumber(object):
    ...
    """
    def __init__(self, public_key, ciphertext, exponent=0, isobfuscated=False):
        self.public_key = public_key
        self.__ciphertext = ciphertext
        self.exponent = exponent
        self.__is_obfuscated = isobfuscated
